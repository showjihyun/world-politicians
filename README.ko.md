...
- **근거는 기계가 걸러낸 것이지 사람이 검증한 것이 아닙니다.** LLM 이 본문이 아니라 제목으로 판단하므로 애매한 건이 남습니다. 링크된 기사는 참고 맥락이지 사람이 확인한 인용이 아닙니다. 최근 보도는 Google News, 과거 사건은 GDELT 아카이브(2017년부터)에서 가져옵니다. 남은 48개는 대부분 두 소스 모두 닿지 않는 2017년 이전 관계입니다.
