...
- **자동 수집된 출처는 인용이 아니라 동반 언급입니다.** 각 엣지에 붙은 근거는 두 인물이 함께 등장하는 기사를 검색해 모은 것입니다. 따라서 실제로 그 관계를 뒷받침하지 않는 기사가 섞일 수 있고, 화면에도 그렇게 표시됩니다. 후보를 실제 인용으로 승격하는 것은 수작업이며 대부분의 엣지는 아직 그 단계를 거치지 않았습니다.
