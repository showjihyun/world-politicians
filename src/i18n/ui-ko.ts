...
export const UI_KO: UIDict = {
  ...
  fundingTitle: '선거 자금',
  fundingReceipts: '총 수입',
  fundingIndividual: '개인',
  fundingPac: 'PAC',
  fundingRefunded: (amt: string) => `${amt} 반환`,
  fundingOutside: '외부 지출',
  fundingFor: '지지',
  fundingAgainst: '반대',
  fundingCaveat: '공시된 직접 기부에 한합니다. 개인 기부는 이름이 아니라 총액으로만 신고됩니다. 외부 지출은 기부가 아닙니다 — 후보와 조율이 금지되어 있고, 반대에 쓴 돈은 따로 셉니다.',
  lobbyTitle: '회전문',
  lobbyLede: (n: number) => `전직 보좌진 ${n}명이 등록 로비스트입니다`,
  lobbyClients: '이들의 고객',
  lobbyCaveat: 'LD-1 등록서의 신고 항목으로, 로비스트가 과거에 맡았던 직위입니다. 여기서 일했다는 뜻이지 이 의원실을 로비한다는 뜻이 아닙니다. 이들의 고객은 기업입니다.',
