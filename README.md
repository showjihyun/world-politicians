...
- **Evidence is machine-filtered, not human-verified.** Candidates were gathered by searching for articles naming both people, then an LLM dropped the ones whose headline showed no interaction between them — 52% of 802 candidates were removed. What survives is materially better (a "$40T debt under Trump and Biden" piece no longer sits under the Trump–Biden feud edge), but it is judged from headlines alone and marginal cases get through. **208 of 266 edges have evidence; 58 have none and say so** — mostly older relationships that recent-news search cannot reach.
